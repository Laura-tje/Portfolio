...
export default function Contact() {
  ...
  const socialLinks = [
    { name: "GitHub", url: siteConfig.socials.github, description: language === "nl" ? "Bekijk mijn code en projecten" : "Check out my code and projects", icon: <GitHub className="w-8 h-8" /> },
    { name: "LinkedIn", url: siteConfig.socials.linkedin, description: language === "nl" ? "Connect met mij" : "Connect with me", icon: <LinkedIn className="w-8 h-8" /> },
    { name: "Itch.io", url: siteConfig.socials.itch, description: language === "nl" ? "Speel mijn games" : "Play my games", icon: <Itch className="w-8 h-8" /> },
  ];
    ...
    <div className="py-12 px-4">
      <div className="container mx-auto max-w-5xl">
        ...
        <div className="text-center mb-12">
          <h1 className="text-5xl font-bold text-(--text) mb-4">{language === "nl" ? "Contact" : "Contact"}</h1>
          <p className="text-xl text-(--muted) max-w-2xl mx-auto">
            {language === "nl" ? "Interesse in samenwerking of gewoon een vraag? Neem gerust contact op!" : "Interested in collaboration or just a question? Feel free to reach out!"}
          </p>
        </div>
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:flex-1 flex flex-col gap-4">
            <h2 className="text-2xl font-bold text-(--text) mb-2">{t("findOnline")}</h2>
